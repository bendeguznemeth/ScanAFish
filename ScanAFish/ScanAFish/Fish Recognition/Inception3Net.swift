...
class Inception3Net{
    ...
    init(withCommandQueue inputCommandQueue : MTLCommandQueue){
        ...
        sid.storageMode = .private
        inid.storageMode = .private
        m0id.storageMode = .private
        m1id.storageMode = .private
        m2id.storageMode = .private
        m3id.storageMode = .private
        m4id.storageMode = .private
        m5id.storageMode = .private
        m6id.storageMode = .private
        m7id.storageMode = .private
        m8id.storageMode = .private
        m9id.storageMode = .private
        m10id.storageMode = .private
